...
public class ReplyAspect {
     ...
     */
    @Pointcut("@annotation(com.tsingtec.follow.handler.annotation.ReplyAnnotation)")
    ...
    private void sendUniformMsg(ProceedingJoinPoint joinPoint) {
        ...
        ReviewPlanReplyReqVO vo = BeanMapper.map(arg,ReviewPlanReplyReqVO.class);
        ...
        if(subscription!=null && subscription.getAccept()){
            ...
            data.add(new WxMaSubscribeMessage.MsgData("thing2","您的医生["+doctor.getName()+"]刚才回复了您的复查信息"));
            ...
            wxMaSubscribeMessage.setPage("/pages/personal/review/detail?id="+reviewPlan.getId());
